...
import { mainAddProjectCard, mainRemoveProject, myProjectsLoad, singleProjectLoad } from "./main-content-load";
...
pubsub.subscribe('ADD_PROJECT', data => { USER.addProject(data) });
